...
public class AppUtility {
    ...
    public static void saveString(Context context, String key, String value) {
        getSharedPreferences(context).edit().putString(String.valueOf(key), Base64.encodeToString(value.getBytes(), Base64.DEFAULT)).apply();
    }

    public static String getString(Context context, String key, String defaultValue) {
        String val = getSharedPreferences(context).getString(key, "");
        if (!val.isEmpty()) {
