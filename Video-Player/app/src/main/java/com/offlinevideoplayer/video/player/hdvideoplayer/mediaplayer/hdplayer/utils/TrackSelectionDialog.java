        ...
        trackSelectionDialog.init(
                ...
                /* onClickListener= */ (dialog, which) -> {
                    ...
                    for (int rendererIndex = 0; rendererIndex < mappedTrackInfo.getRendererCount(); rendererIndex++) {
                        ((DefaultTrackSelector.ParametersBuilder) builder).clearSelectionOverrides(rendererIndex).setRendererDisabled(rendererIndex, trackSelectionDialog.getIsDisabled(rendererIndex));
                        List<DefaultTrackSelector.SelectionOverride> overrides = trackSelectionDialog.getOverrides(rendererIndex);
...
//        new AppCompatDialog(getActivity(), R.style.TrackSelectionDialogThemeOverlay);
                new AppCompatDialog(getActivity(), R.style.PropertyDialog);
