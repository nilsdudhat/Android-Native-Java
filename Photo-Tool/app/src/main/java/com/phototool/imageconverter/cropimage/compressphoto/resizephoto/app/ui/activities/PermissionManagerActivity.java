...
public abstract class PermissionManagerActivity extends AdsBaseActivity {
            ...
            for (int grantResult : grantResults) {
                if (grantResult != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(PermissionManagerActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        ...
                        snackBarView.setTranslationY(-(AppUtils.convertDpToPixel(48, PermissionManagerActivity.this)));

                        snackbar.setAction(R.string.action_grant, view -> requestPermissions());
                        snackbar.setActionTextColor(ContextCompat.getColor(PermissionManagerActivity.this, R.color.purple_200));
                        snackbar.show();
                    } else {
                        ...
                        snackbar.setActionTextColor(ContextCompat.getColor(PermissionManagerActivity.this, R.color.purple_500));
                        snackbar.show();
                    }
                    return;
                }
