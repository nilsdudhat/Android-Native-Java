...
import com.iphoto.iphonegallery.iosgallerylauncher.photoios.iosgallery.forandroid.adsintegration.AppOpenAdManager;
...
public class MyApplication extends Application
    ...
    public void onCreate() {
        ...
        if (AdUtils.isNetworkAvailable(this)) { // check for internet availability
            if (AdUtils.displayAds) { // check if ads are enabled ot not
                if (AdUtils.displayOpenAppAds) { // check if open ads is enabled or not
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            handler.postDelayed(this, 60 * 60 * 1000); // handler loop to reload open ad
                        }
                    });
                }
            }
...
//                    if (!(currentActivity instanceof AlbumGridActivity) &&
//                            !(currentActivity instanceof MoreAlbumsActivity)) {
