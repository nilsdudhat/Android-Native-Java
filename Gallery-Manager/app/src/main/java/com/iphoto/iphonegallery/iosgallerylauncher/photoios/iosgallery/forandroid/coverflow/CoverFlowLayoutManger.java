package com.iphoto.iphonegallery.iosgallerylauncher.photoios.iosgallery.forandroid.coverflow;
...
//        cm.setSaturation(0.9f);
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        // TODO: Loop mode does not support smooth scrolling
        Log.d("--smooth_scroll--", "smoothScrollToPosition: " + mIsLoop);
        if (mIsLoop) return;
