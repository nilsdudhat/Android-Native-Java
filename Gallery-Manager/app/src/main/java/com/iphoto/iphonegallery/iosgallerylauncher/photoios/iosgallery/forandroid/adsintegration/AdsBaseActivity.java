package com.iphoto.iphonegallery.iosgallerylauncher.photoios.iosgallery.forandroid.adsintegration;
        ...
        if (AdUtils.displayAds) {
            if (AdUtils.displayInterstitialAds) {
                ...
                if (AdUtils.isNetworkAvailable(activity)) {
                    ...
                    Log.d("--show_interstitial--", "AdUtils.isNetworkAvailable(activity): else");
