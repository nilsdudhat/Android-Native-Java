...
public class Constant {
    public static String BASE_URL = "https://video.grayfoxinfo.in//api/";
    ...
    public static final String GOOGLE_REWARD = "GOOGLE_REWARD";
    public static final String IS_FACEBOOK_AD = "IS_FACEBOOK_AD";
    public static final String FACEBOOK_REWARD = "FACEBOOK_REWARD";
