...
public class MyAppCustomScaleGesture {
    ...
    private final MyAppCustomVector2D mCurrSpanVector = new MyAppCustomVector2D();
    ...
    public MyAppCustomScaleGesture(OnScaleGestureListener onScaleGestureListener) {
    ...
    public MyAppCustomVector2D getCurrentSpanVector() {
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, MyAppCustomScaleGesture myAppCustomScaleGesture);

        boolean onScaleBegin(View view, MyAppCustomScaleGesture myAppCustomScaleGesture);

        void onScaleEnd(View view, MyAppCustomScaleGesture myAppCustomScaleGesture);
    }
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, MyAppCustomScaleGesture myAppCustomScaleGesture) {
        }
    }
}
