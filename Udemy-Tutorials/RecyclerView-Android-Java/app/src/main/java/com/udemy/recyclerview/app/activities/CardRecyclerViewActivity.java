...
import com.udemy.recyclerview.app.adapters.CardAdapter;
import com.udemy.recyclerview.app.databinding.ActivityCardRecyclerViewBinding;
...
public class CardRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCardRecyclerViewBinding.inflate(getLayoutInflater());
    ...
    private void setUpRecyclerView() {
        LinearLayoutManager layoutManager = new LinearLayoutManager(
                CardRecyclerViewActivity.this, LinearLayoutManager.VERTICAL, false);
        ...
        binding.rvPlanets.setAdapter(cardAdapter);

        cardAdapter.setPlanetModelArrayList(planetModelArrayList);
    }
}