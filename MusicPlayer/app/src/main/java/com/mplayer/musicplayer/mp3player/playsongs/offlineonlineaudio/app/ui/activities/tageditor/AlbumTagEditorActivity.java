...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.util.LastFMUtil;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    protected void loadCurrentImage() {
        ...
        setImageBitmap(bitmap, PlayerColorUtil.getColor(PlayerColorUtil.generatePalette(bitmap), ATHUtil.resolveColor(this, R.attr.defaultFooterColor)));
                ...
                if (lastFmAlbum.getAlbum() != null) {
                    ...
                    if (!TextUtils.isEmpty(url) && url.trim().length() > 0) {
                        Glide.with(AlbumTagEditorActivity.this)
                                ...
                                .error(R.drawable.drawable_album)
                                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                                    ...
                                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                                        ...
                                        setImageBitmap(albumArtBitmap, PlayerColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                                        deleteAlbumArt = false;
                                        dataChanged();
                                        setResult(RESULT_OK);
                                    }
    ...
    protected void deleteImage() {
        setImageBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.drawable_album), ATHUtil.resolveColor(this, R.attr.defaultFooterColor));
        deleteAlbumArt = true;
        dataChanged();
    }
    ...
    protected void loadImageFromFile(@NonNull final Uri selectedFileUri) {
        Glide.with(AlbumTagEditorActivity.this)
                ...
                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                    ...
                    @Override
                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                        PlayerColorUtil.getColor(resource.getPalette(), Color.TRANSPARENT);
                        albumArtBitmap = ImageUtil.resizeBitmap(resource.getBitmap(), 2048);
                        setImageBitmap(albumArtBitmap, PlayerColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                        deleteAlbumArt = false;
                        dataChanged();
