package com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.glide.palette;
...
public class BitmapPaletteTranscoder implements ResourceTranscoder<Bitmap, BitmapPaletteWrapper> {
    ...
    @Override
    public String getId() {
        return "BitmapPaletteTranscoder.com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.glide.palette";
    }
}