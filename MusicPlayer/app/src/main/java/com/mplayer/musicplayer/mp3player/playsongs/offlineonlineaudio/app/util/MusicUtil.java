...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.model.lyrics.AbsSynchronizedLyrics;
...
//        );
    ...
    public static void deleteTracks(@NonNull final Context context, @NonNull final List<Song> songs) {
        ...
        Log.d("--delete--", "deleteTracks projection: " + projection);
        ...
        selection.append(")");
        Log.d("--delete--", "deleteTracks selection: " + selection);
        ...
        try {
            final Cursor cursor = context.getContentResolver().query(
                    ...
                    null, null);
            Log.d("--delete--", "deleteTracks cursor: " + cursor);
            if (cursor != null) {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    Log.d("--delete--", "deleteTracks id: " + id);
                    final Song song = SongLoader.getSong(context, id);
                    Log.d("--delete--", "deleteTracks song: " + song);
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    Log.d("--delete--", "deleteTracks name: " + name);
                    try { // File.delete can throw a security exception
                        final File f = new File(name);
                        Log.d("--delete--", "deleteTracks f: " + f.getAbsolutePath());
                        if (f.delete()) {
                            Log.d("--delete--", "deleteTracks: " + "file deleted");
                            ...
                            Log.d("--delete--", "deleteTracks: " + "file not deleted");
                        ...
                        Log.e("--delete--", "deleteTracks ex: " + ex.getMessage());
                        cursor.moveToNext();
                    } catch (NullPointerException e) {
                        Log.e("--delete--", "deleteTracks e: " + e.getMessage());
            ...
            Log.e("--delete--", "deleteTracks ignored: " + ignored.getMessage());
