...
public class FlatPlayerFragment extends PlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
...
//        }
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public void init() {
            ...
            currentSongViewHolder.image.setVisibility(View.GONE);
...
//            createDefaultColorChangeAnimatorSet(newColor).start();
    ...
    private static class LandscapeImpl extends BaseImpl {
        ...
        @Override
        public void setUpPanelAndAlbumCoverHeight() {
            ((SlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.getView().findViewById(R.id.player_panel));
        }
