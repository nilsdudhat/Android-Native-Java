...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.adapter.AlbumCoverPagerAdapter;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.misc.SimpleAnimatorListener;
...
public class PlayerAlbumCoverFragment extends MusicServiceFragment implements ViewPager.OnPageChangeListener, MusicProgressViewUpdateHelper.Callback {
...
//        ((AlbumCoverPagerAdapter) viewPager.getAdapter()).receiveColor(colorReceiver, position);
    ...
    public void showHeartAnimation() {
        ...
        favoriteIcon.animate()
                .setDuration(ViewUtil.ANIM_TIME / 2)
