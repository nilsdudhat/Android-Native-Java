...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.adapter.song.PlayingQueueAdapter;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.dialogs.LyricsDialog;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.helper.OnSwipeListener;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.model.lyrics.Lyrics;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.ui.activities.base.SlidingMusicPanelActivity;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.ui.fragments.player.PlayerAlbumCoverFragment;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.ui.fragments.player.PlayerFragment;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.util.ImageUtil;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.views.WidthFitSquareLayout;
import com.sothree.slidinguppanel.SlidingUpPanelLayout;

public class CardPlayerFragment extends PlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener, View.OnTouchListener {
    ...
    private void initViews(View view) {
        ...
        playingQueueCard = view.findViewById(R.id.playing_queue_card);
        ...
        playerPanel = view.findViewById(R.id.player_panel);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        gestureDetectorCompat = new GestureDetectorCompat(requireContext(), new OnSwipeListener() {

            @Override
            public Direction getDirection(float x1, float y1, float x2, float y2) {
                Log.d("swipe-----", "getDirection x1: " + x1);
                Log.d("swipe-----", "getDirection x1: " + x2);
                Log.d("swipe-----", "getDirection y1: " + y1);
                Log.d("swipe-----", "getDirection y2: " + y2);
                return super.getDirection(x1, y1, x2, y2);
            }
...
//                    imgSwipe.setImageResource(R.drawable.ic_swipe_down);
//                } else {
//                    Log.d("swipe-----", "onSwipe: down");
//                    imgSwipe.setImageResource(R.drawable.ic_swipe_up);
//                }
//                return true;
//            }
        });

        playerPanel.setOnTouchListener(this);
...
//
//    private boolean manageMotionEvents(MotionEvent event) {
...
//    }
    ...
    private void updateIsFavorite() {
        ...
        updateIsFavoriteTask = new AsyncTask<Song, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean isFavorite) {
                Activity activity = requireActivity();
                if (activity != null) {
                    int res = isFavorite ? R.drawable.ic_favorite : R.drawable.ic_like_stroke;
                    ...
                    playbackControlsFragment.img_favorite.setImageResource(res);
                }
            }
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            animatorSet.setDuration(ViewUtil.ANIM_TIME);
            return animatorSet;
        }
...
//            currentSongViewHolder.image.setImageResource(R.drawable.ic_volume_up_white_24dp);
            currentSongViewHolder.image.setVisibility(View.VISIBLE);
            ...
            currentSongViewHolder.menu.setOnClickListener(new SongMenuHelper.OnClickSongMenu((AdsBaseActivity) fragment.getActivity()) {
                @Override
                public Song getSong() {
                    return currentSong;
                }
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            ...
            ((SlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.slidingUpPanelLayout.findViewById(R.id.player_panel));
        }
        ...
        public void updateCurrentSong(Song song) {
            ...
            SongGlideRequest.Builder.from(Glide.with(fragment.requireActivity()), song)
                    .checkIgnoreMediaStore(fragment.requireActivity()).build()
