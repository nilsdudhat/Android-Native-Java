...
public abstract class LibraryPagerCustomGridSizeFragment<A extends RecyclerView.Adapter, LM extends RecyclerView.LayoutManager> extends LibraryPagerRecyclerViewFragment<A, LM> {
...
//        Log.d("--fragment--", "getItemLayoutRes: " + LibraryFragment.newInstance().getCurrentFragment());
    ...
    protected int getItemLayoutResForArtist() {
        if (getGridSize() > getMaxGridSizeForList()) {
