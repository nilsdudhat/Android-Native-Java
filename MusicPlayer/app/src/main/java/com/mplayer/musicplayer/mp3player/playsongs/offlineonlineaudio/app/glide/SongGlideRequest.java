...
public class SongGlideRequest {
    ...
    public static final int DEFAULT_ERROR_SONG_IMAGE = R.drawable.drawable_song;
    public static final int DEFAULT_ERROR_ALBUM_IMAGE = R.drawable.drawable_album;
    ...
    public static class Builder {
        ...
        public DrawableRequestBuilder<GlideDrawable> buildWithDisc() {
            //noinspection unchecked
            return createBaseRequest(requestManager, song, ignoreMediaStore)
                    .diskCacheStrategy(DEFAULT_DISK_CACHE_STRATEGY)
    ...
    public static class PaletteBuilder {
        ...
        public BitmapRequestBuilder<?, BitmapPaletteWrapper> buildWithDisc() {
            //noinspection unchecked
            return createBaseRequest(builder.requestManager, builder.song, builder.ignoreMediaStore)
                    .asBitmap()
                    .transcode(new BitmapPaletteTranscoder(context), BitmapPaletteWrapper.class)
