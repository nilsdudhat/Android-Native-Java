...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.misc.CustomFragmentStatePagerAdapter;
...
//            forceSquareAlbumCover(PreferenceUtil.getInstance(getContext()).forceSquareAlbumCover());
        ...
        private void loadAlbumCover() {
            SongGlideRequest.Builder.from(Glide.with(requireActivity()), song)
                    .checkIgnoreMediaStore(getActivity())
                    .generatePalette(getActivity()).build()
                    .into(new ColoredTarget(albumCover) {
                        @Override
