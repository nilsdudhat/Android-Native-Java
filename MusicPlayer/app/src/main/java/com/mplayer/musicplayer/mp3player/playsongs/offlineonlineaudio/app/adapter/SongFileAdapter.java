...
public class SongFileAdapter extends MultiSelectAdapter<SongFileAdapter.ViewHolder, File> implements FastScrollRecyclerView.SectionedAdapter {
...
//            holder.image.setColorFilter(iconColor, PorterDuff.Mode.SRC_IN);
            holder.image.setImageResource(R.drawable.album_disc);
            holder.image.setBackgroundResource(R.drawable.bg_disc);
        } else {
            Drawable error = ImageUtil.getTintedVectorDrawable(activity, R.drawable.drawable_song, iconColor);
            Glide.with(activity)
                    .load(new AudioFileCover(file.getPath()))
                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                    .error(R.drawable.drawable_song)
                    .placeholder(error)
