...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.adapter.GenreAdapter;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.interfaces.LoaderIds;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.loader.GenreLoader;
...
public class GenresFragment extends LibraryPagerRecyclerViewFragment<GenreAdapter, LinearLayoutManager> implements LoaderManager.LoaderCallbacks<List<Genre>> {
