...
public class PlayingQueueAdapter extends SongAdapter implements DraggableItemAdapter<PlayingQueueAdapter.ViewHolder> {
    ...
    public PlayingQueueAdapter(AdsBaseActivity activity, List<Song> dataSet, int current, @LayoutRes int itemLayoutRes, boolean usePalette, @Nullable CabHolder cabHolder) {
...
//            }
        ...
        public void onClick(View v) {
            ...
            SongGlideRequest.Builder.from(Glide.with(activity), MusicPlayerRemote.getCurrentSong())
                    .checkIgnoreMediaStore(activity).build()
                    .placeholder(R.drawable.drawable_song)
                    .into(image);
        }
