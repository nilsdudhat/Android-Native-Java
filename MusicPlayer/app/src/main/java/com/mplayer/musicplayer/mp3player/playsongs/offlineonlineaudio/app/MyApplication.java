package com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.AdsIntegration.AppOpenAdManager;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.appshortcuts.DynamicShortcutManager;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.ui.activities.SplashActivity;
    ...
    public void onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 1)) {
            ThemeStore.editTheme(this)
                    .primaryColorRes(com.kabouzeid.appthemehelper.R.color.md_indigo_500)
                    .accentColorRes(com.kabouzeid.appthemehelper.R.color.md_pink_A400)
                    .commit();
        }
