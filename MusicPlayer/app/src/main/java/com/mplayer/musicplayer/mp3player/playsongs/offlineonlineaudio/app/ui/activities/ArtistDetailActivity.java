...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.adapter.album.HorizontalAlbumAdapter;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.adapter.song.ArtistSongAdapter;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.glide.ArtistGlideRequest;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.lastfm.rest.model.LastFmArtist;
 ...
 */
public class ArtistDetailActivity extends SlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
...
//            artistImage.setTranslationY(Math.max(-scrollY, -headerViewHeight));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llShuffle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                List<Song> songs = songAdapter.getDataSet();
    ...
    private void setUpObservableListViewParams() {
        ...
        Log.d("--height--", "height 1: " + headerViewHeight);
    }
    ...
    private void loadArtistImage() {
        ArtistGlideRequest.Builder.from(Glide.with(this), artist)
                ...
                .dontAnimate()
                .into(new ColoredTarget(artistImage) {
                    @Override
