package com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.service;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.appwidgets.AppWidgetBig;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.appwidgets.AppWidgetCard;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.appwidgets.AppWidgetClassic;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.appwidgets.AppWidgetSmall;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.glide.BlurTransformation;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.glide.SongGlideRequest;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.helper.ShuffleHelper;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.helper.StopWatch;
...
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.provider.MusicPlaybackQueueStore;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.provider.SongPlayCountStore;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.service.notification.PlayingNotification;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.service.notification.PlayingNotificationImpl;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.service.notification.PlayingNotificationImpl24;
import com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.service.playback.Playback;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PACKAGE_NAME = "com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.MUSIC_SERVICE_CREATED"));
    }
...
//        PendingIntent mediaButtonReceiverPendingIntent = null;
...
//
//        } else {
//            mediaButtonReceiverPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 0, mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
//
//        }
        PendingIntent mediaButtonReceiverPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 0, mediaButtonIntent, PendingIntent.FLAG_MUTABLE);

        mediaSession = new MediaSessionCompat(this, "mPlayer", mediaButtonReceiverComponentName, mediaButtonReceiverPendingIntent);
...
//                | MediaSession.FLAG_HANDLES_MEDIA_BUTTONS);
                    ...
                    case ACTION_PLAY_PLAYLIST:
                        ...
                        if (playlist != null) {
                            ...
                            if (playlist instanceof CustomPlaylist) {
                                playlistSongs = ((CustomPlaylist) playlist).getSongs(getApplicationContext());
                            } else {
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.mplayer.musicplayer.mp3player.playsongs.offlineonlineaudio.app.MUSIC_SERVICE_DESTROYED"));
    }
