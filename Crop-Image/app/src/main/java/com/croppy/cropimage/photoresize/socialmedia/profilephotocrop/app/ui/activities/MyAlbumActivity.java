...
import com.croppy.cropimage.photoresize.socialmedia.profilephotocrop.app.adapters.ImageAdapter;
import com.croppy.cropimage.photoresize.socialmedia.profilephotocrop.app.adsintegration.AdsBaseActivity;
import com.croppy.cropimage.photoresize.socialmedia.profilephotocrop.app.databinding.ActivityAlbumBinding;
...
import com.croppy.cropimage.photoresize.socialmedia.profilephotocrop.app.media.MediaLoader;
import com.croppy.cropimage.photoresize.socialmedia.profilephotocrop.app.models.ImageModel;
import com.croppy.cropimage.photoresize.socialmedia.profilephotocrop.app.utils.DeleteMediaManager;
...
public class MyAlbumActivity extends AdsBaseActivity implements ImageClickListener, DeleteClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showBannerAd(MyAlbumActivity.this, binding.adBanner);
...
//                binding.llSelectinToolbar.setVisibility(View.GONE);
//                binding.header.setVisibility(View.VISIBLE);
            }
        });

        binding.tvTitleAlbumImage.setText(getString(R.string.full_app_name));
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                pathList = MediaLoader.loadFilesFromFolder(MyAlbumActivity.this, getString(R.string.full_app_name));
